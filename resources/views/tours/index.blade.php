                        ...
                        <div class="wrap-division">
                            @foreach ($tours as $tour)
                                <div class="col-md-6 col-sm-6 animate-box">
                                    <div class="tour">
                                        <a href="{{ route('tours.show', ['tour' => $tour->id]) }}" class="tour-img"
                                            style="background-image: url({{ asset($tour->image) }});">
                                            <p class="price"><span>${{ $tour->price }}</span> <small>/
                                                    {{ $tour->days }} Days</small></p>
                                        </a>
                                        <span class="desc">
                                            <p class="star"><span>
                                                    @php
                                                        $reviewCount = count($tour->approvedReviews());
                                                        $averageRating = $reviewCount
                                                            ? round($tour->approvedReviews()->avg('rating'), 1)
                                                            : 0;
                                                    @endphp
                                                    @for ($i = 1; $i <= 5; $i++)
                                                        <i
                                                    ...
                                                    @endfor
                                                    {{ count($tour->approvedReviews()) }} Reviews</p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-field">
                                                ...
                                                <select name="location" id="location" class="form-control bg-dark">
                                                    ...
                                                    @foreach ($tours as $tour)
                                                        <option class="text-primary" value="{{ $tour->location }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-field">
                                                ...
                                                <input type="text" id="date" class="form-control date"
                                                    name="check_in_date" placeholder="Check-in date">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-field">
                                                <i class="icon icon-calendar2"></i>
                                                <input type="text" id="date" class="form-control date"
                                                    name="check_out_date" placeholder="Check-out date">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <input type="submit" name="submit" id="submit" value="Find Tours"
