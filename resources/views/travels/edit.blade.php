...
<div class="container-fluid" id="container-wrapper">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
        <form action="{{ route('travels.update', $travel) }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PATCH')
          <div class="row">
            <div class="form-group col-lg-4">
                <label for="title">Title</label>
                <input type="text" value="{{ old('title') ? old('title') : $travel->title }}" name="title"  class="form-control" id="title" aria-describedby="titleHelp"
                placeholder="Title">
                @if ($errors->has('title'))
            ...
            <div class="form-group col-lg-4">
                ...
                <input type="text" value="{{ old('country') ? old('country') : $travel->country }}" name="country"  class="form-control" id="country" aria-describedby="countryHelp"
                placeholder="Country">
            ...
            <div class="form-group col-lg-4">
                ...
                <input type="text" value="{{ old('city') ? old('city') : $travel->city }}" name="city" class="form-control" id="city" aria-describedby="nameHelp"
          ...
          <div class="row">
              <div class="form-group col-lg-4">
                  ...
                  <input type="starting" value="{{ old('starting') ? old('starting') : $travel->starting }}" name="starting" class="form-control" id="starting" aria-describedby="emailHelp"
              ...
              <div class="form-group col-lg-4">
                  ...
                  <input type="destination" value="{{ old('destination') ? old('destination') : $travel->destination }}" name="destination" class="form-control" id="destination" aria-describedby="emailHelp"
          ...
          <div class="row">
            <div class="form-group col-lg-2">
              ...
              <input type="number" value="{{ old('price') ? old('price') : $travel->price }}" name="price" class="form-control" id="name" aria-describedby="nameHelp"
            ...
            <div class="form-group col-lg-2">
              ...
              <input type="number" value="{{ old('duration') ? old('duration') : $travel->duration }}" name="duration" class="form-control" id="name" aria-describedby="nameHelp"
            ...
            <div class="form-group col-lg-2">
              ...
              <input type="number" value="{{ old('people') ? old('people') : $travel->people }}" name="people" class="form-control" id="name" aria-describedby="nameHelp"
            ...
            <div class="form-group col-lg-2">
              ...
              <input type="number" value="{{ old('rating') ? old('rating') : $travel->rating }}" name="rating" class="form-control" id="name" aria-describedby="nameHelp"
            ...
            <div class="form-group col-lg-2">
              ...
              <input type="number" value="{{ old('reviews') ? old('reviews') : $travel->reviews }}" name="reviews" class="form-control" id="name" aria-describedby="nameHelp"
            ...
            {{-- {{dd($travel->round_trip)}} --}}
            <div class="form-group ">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" name="round_trip" value="1" class="custom-control-input" id="customControlAutosizing" {{ $travel->round_trip==1 ? 'checked' : '' }}>
