                    ...
                    textAreas += `
                        <div class="row">
                            ...
                            <div class="form-group col-lg-8">
                                ...
                                <textarea  class="form-control" value="{{ old('description') ? old('description') : $tour->description }}" name="descriptions[${filesProcessed}]" id="mytextarea" rows="5" placeholder="Enter Tour description Here" required></textarea>
