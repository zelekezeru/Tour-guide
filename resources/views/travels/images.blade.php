        ...
        <div class="col-md-12">
            <div class="wrap-division">
                <div class="col-md-12 col-md-offset-0 heading2 animate-box">
                    <h2>{{ $travel->title }}, </h2>
                    <h4>{{ $travel->starting }} -> {{ $travel->destination }} </h4>
                </div>
            </div>
        </div>
          ...
          <input type="text" name="travel_id" value="{{ $travel->id }}" hidden>
            ...
            <div class="row">
                <div class="form-group col-lg-8">
                    ...
                    <textarea  class="form-control"  value="{{ old('description') ? old('description') : $travel->description }}" name="description" id="mytextarea"  rows="5"  placeholder="Enter Travel description Here" required></textarea>
