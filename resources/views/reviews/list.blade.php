                        ...
                        <tbody>
                            ...
                            @foreach ($reviews as $review)
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        @if ($review->photo)
                                            <img src="{{ asset($review->photo) }}" alt="" class="rounded-circle"
                                    ...
                                    <td>
                                        @for ($star = 1; $star <= 5; $star++)
                                            <i
                                                class="{{ $star <= $review->rating ? 'fas' : 'far' }} fa-star text-warning"></i>
                                        @endfor
                                    </td>
                                    <td class="text-left">
                                    ...
                                    <td class="text-nowrap">
                                        ...
                                        <button onclick="confirmDelete({{ $review->id }})"
                                            class="btn mr-2 btn-sm btn-danger">Delete</button>
                                    </td>
                                </tr>
                            @endforeach
                            @if ($reviews->isEmpty())
